      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">
            Publish and manage news updates
          </p>
        </div>
          ...
          <tbody>
            {filteredArticles.length === 0 ? (
              ...
              filteredArticles.map((article) => (
                <tr key={article.id} className="border-t border-gray-200 hover:bg-gray-50 transition">
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(article.status)}`}>
